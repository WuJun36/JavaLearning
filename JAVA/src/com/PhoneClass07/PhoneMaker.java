...
public class PhoneMaker {
    public static void main(String[] args){
        ...
        // 可以设置断点查看实例内部状态
        phone.hasFigurePrintUnlock = true;
        phone.price = 2999.9;
        // 创建一个Screen实例，给phone实例的screen引用赋值
        phone.screen = new Screen();
        // 通过引用phone占到Phone的对象，通过screen找到Screen对象，通过.producer给之赋值
        phone.screen.producer = "京东方";
        phone.screen.size = 6.6;

        Mainboard mainboard = new Mainboard();
        mainboard.model = "EA999";
        mainboard.year = 2019;
